...
class AboutTheAuthor(QWidget):
    ...
    def initUI(self):
        ...
        grid.addWidget(self.welcome_title, 0, 0, 1, 1)
        # Author Info
        ...
        grid.addWidget(self.author_info, 3, 1, 1, 2)

        # Add button links to the functions
        self.introduction_text = QLabel(self, alignment=Qt.AlignLeft)
        ...
        grid.addWidget(self.introduction_text, 1, 0, 1, 2)

        self.pic = QLabel(self, alignment=Qt.AlignTop)
        grid.addWidget(self.pic, 1, 2)
        # use full ABSOLUTE path to the image, not relative
        self.pic.setPixmap(QPixmap(os.getcwd() + "/Craig_Photo.jpg"))
